...
enum AppCatalog {
    static let all: [CatalogApp] = [
        ...
        CatalogApp(id: "settings", name: "Settings", symbol: "gearshape.fill", tint: .gray,
                   scheme: "app-settings:", webFallback: nil, isVerified: true, category: .system),
        CatalogApp(id: "calendar", name: "Calendar", symbol: "calendar", tint: .red,
                   scheme: "calshow://", webFallback: nil, isVerified: true, category: .system),
        ...
        CatalogApp(id: "safari", name: "Safari", symbol: "safari.fill", tint: .blue,
                   scheme: "x-web-search://", webFallback: "https://www.apple.com/", isVerified: true, category: .productivity),
        ...
        CatalogApp(id: "spotify", name: "Spotify", symbol: "waveform", tint: .green,
                   scheme: "spotify://", webFallback: "https://open.spotify.com/", isVerified: true, category: .media),
        CatalogApp(id: "youtube", name: "YouTube", symbol: "play.rectangle.fill", tint: .red,
                   scheme: "youtube://", webFallback: "https://www.youtube.com/",
                   alternates: ["vnd.youtube://"], isVerified: true, category: .media),
        CatalogApp(id: "netflix", name: "Netflix", symbol: "tv.fill", tint: .red,
                   scheme: "nflx://", webFallback: "https://www.netflix.com/", isVerified: true, category: .media),
        ...
        CatalogApp(id: "instagram", name: "Instagram", symbol: "camera.circle.fill", tint: .purple,
                   scheme: "instagram://", webFallback: "https://www.instagram.com/", isVerified: true, category: .social),
        ...
        CatalogApp(id: "reddit", name: "Reddit", symbol: "bubble.left.and.bubble.right.fill", tint: .orange,
                   scheme: "reddit://", webFallback: "https://www.reddit.com/", isVerified: true, category: .social),
        CatalogApp(id: "discord", name: "Discord", symbol: "bubble.left.fill", tint: .indigo,
                   scheme: "discord://", webFallback: "https://discord.com/app",
                   alternates: ["com.hammerandchisel.discord://"], isVerified: true, category: .social),
        ...
        CatalogApp(id: "slack", name: "Slack", symbol: "number.square.fill", tint: .purple,
                   scheme: "slack://", webFallback: "https://slack.com/", isVerified: true, category: .productivity),
        ...
        CatalogApp(id: "gcal", name: "Google Calendar", symbol: "calendar.badge.clock", tint: .blue,
                   scheme: "comgooglecalendar://", webFallback: "https://calendar.google.com/", isVerified: true, category: .productivity),
        ...
        CatalogApp(id: "chatgpt", name: "ChatGPT", symbol: "sparkles", tint: .teal,
                   scheme: "chatgpt://", webFallback: "https://chatgpt.com/", isVerified: true, category: .productivity),
        CatalogApp(id: "claude", name: "Claude", symbol: "asterisk", tint: .orange,
                   scheme: "claude://", webFallback: "https://claude.ai/", isVerified: true, category: .productivity),
        CatalogApp(id: "gmaps", name: "Google Maps", symbol: "location.fill", tint: .green,
                   ...
                   alternates: ["googlemaps://"], isVerified: true, category: .travel),
        CatalogApp(id: "uber", name: "Uber", symbol: "car.fill", tint: .black,
                   scheme: "uber://", webFallback: "https://m.uber.com/", isVerified: true, category: .travel),
        ...
        CatalogApp(id: "clashroyale", name: "Clash Royale", symbol: "crown.fill", tint: .blue,
                   scheme: "clashroyale://", webFallback: "https://link.clashroyale.com/en/", isVerified: true, category: .games),
        ...
        CatalogApp(id: "weather", name: "Weather", symbol: "cloud.sun.fill", tint: .blue,
                   ...
                   alternates: ["x-apple-weather://"], isVerified: true, category: .system),
        ...
        CatalogApp(id: "hulu", name: "Hulu", symbol: "tv.fill", tint: .green,
                   scheme: "hulu://", webFallback: "https://www.hulu.com/", isVerified: true, category: .media),
        ...
        CatalogApp(id: "onepassword", name: "1Password", symbol: "key.fill", tint: .blue,
                   scheme: "onepassword://", webFallback: "https://1password.com/", isVerified: true, category: .productivity),
        ...
        CatalogApp(id: "shortcuts", name: "Shortcuts", symbol: "square.stack.3d.up.fill", tint: .indigo,
                   scheme: "shortcuts://", webFallback: nil, isVerified: true, category: .system),
        CatalogApp(id: "files", name: "Files", symbol: "folder.fill", tint: .blue,
                   scheme: "shareddocuments://", webFallback: nil, isVerified: true, category: .system),
        CatalogApp(id: "findmy", name: "Find My", symbol: "location.circle.fill", tint: .green,
                   scheme: "findmy://", webFallback: nil, isVerified: true, category: .system),
        ...
        CatalogApp(id: "books", name: "Books", symbol: "book.fill", tint: .orange,
                   scheme: "ibooks://", webFallback: nil, isVerified: true, category: .system),
        CatalogApp(id: "stocks", name: "Stocks", symbol: "chart.line.uptrend.xyaxis", tint: .green,
                   scheme: "stocks://", webFallback: nil, isVerified: true, category: .system),
        ...
        CatalogApp(id: "arc", name: "Arc Search", symbol: "safari.fill", tint: .blue,
                   scheme: "arcmobile2://", webFallback: "https://arc.net/", isVerified: true, category: .productivity),
        ...
        CatalogApp(id: "duckduckgo", name: "DuckDuckGo", symbol: "magnifyingglass.circle.fill", tint: .orange,
                   scheme: "ddgLaunch://", webFallback: "https://duckduckgo.com/", isVerified: true, category: .productivity),
        ...
        CatalogApp(id: "ubereats", name: "Uber Eats", symbol: "fork.knife", tint: .green,
                   scheme: "ubereats://", webFallback: "https://www.ubereats.com/", isVerified: true, category: .travel),
        ...
        // From github.com/bhagyas/app-urls, a maintained community list. Its
        // Facebook-SDK schemes, protocol handlers and retired apps are left out:
        // `fb1431194636974533://` is a login callback rather than a way in, and
        // Workflow became Shortcuts years ago. None of these have been watched
        // to work - the list is a record of what vendors registered, and only a
        // phone with the app installed can confirm one.
        CatalogApp(id: "contacts", name: "Contacts", symbol: "person.crop.circle.fill", tint: .brown,
                   scheme: "contacts://", webFallback: nil,
                   category: .system),
        CatalogApp(id: "iclouddrive", name: "iCloud Drive", symbol: "icloud.fill", tint: .blue,
                   scheme: "appleiclouddrive://", webFallback: nil,
                   category: .system),
        CatalogApp(id: "watch", name: "Watch", symbol: "applewatch", tint: .black,
                   scheme: "itms-watch://", webFallback: nil,
                   category: .system),
        CatalogApp(id: "imovie", name: "iMovie", symbol: "film.fill", tint: .purple,
                   scheme: "imovie://", webFallback: nil,
                   isVerified: true, category: .system),
        CatalogApp(id: "garageband", name: "GarageBand", symbol: "pianokeys", tint: .orange,
                   scheme: "garageband://", webFallback: nil,
                   category: .system),
        CatalogApp(id: "classical", name: "Apple Music Classical", symbol: "music.quarternote.3", tint: .red,
                   scheme: "classical://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "gamecenter", name: "Game Center", symbol: "gamecontroller.fill", tint: .blue,
                   scheme: "gamecenter://", webFallback: nil,
                   alternates: ["itms-gc://"], category: .games),
        CatalogApp(id: "word", name: "Word", symbol: "doc.text.fill", tint: .blue,
                   scheme: "word://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "excel", name: "Excel", symbol: "tablecells.fill", tint: .green,
                   scheme: "excel://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "powerpoint", name: "PowerPoint", symbol: "rectangle.on.rectangle.angled", tint: .orange,
                   scheme: "powerpoint://", webFallback: nil,
                   isVerified: true, category: .productivity),
        CatalogApp(id: "onenote", name: "OneNote", symbol: "note.text", tint: .purple,
                   scheme: "onenote://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "googlesheets", name: "Google Sheets", symbol: "tablecells", tint: .green,
                   scheme: "googlesheets://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "googlevoice", name: "Google Voice", symbol: "phone.circle.fill", tint: .blue,
                   scheme: "googlevoice://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "googleearth", name: "Google Earth", symbol: "globe.americas.fill", tint: .blue,
                   scheme: "googleearth://", webFallback: nil,
                   category: .travel),
        CatalogApp(id: "github", name: "GitHub", symbol: "chevron.left.forwardslash.chevron.right", tint: .black,
                   scheme: "github://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "fantastical", name: "Fantastical", symbol: "calendar.badge.clock", tint: .red,
                   scheme: "fantastical://", webFallback: nil,
                   alternates: ["fantastical2://"], category: .productivity),
        CatalogApp(id: "omnifocus", name: "OmniFocus", symbol: "checkmark.seal.fill", tint: .purple,
                   scheme: "omnifocus://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "instapaper", name: "Instapaper", symbol: "text.book.closed.fill", tint: .gray,
                   scheme: "instapaper://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "ifttt", name: "IFTTT", symbol: "arrow.triangle.branch", tint: .black,
                   scheme: "ifttt://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "lastpass", name: "LastPass", symbol: "lock.fill", tint: .red,
                   scheme: "lastpass://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "nextcloud", name: "Nextcloud", symbol: "cloud.fill", tint: .blue,
                   scheme: "nextcloud://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "speedtest", name: "Speedtest", symbol: "speedometer", tint: .blue,
                   scheme: "speedtest://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "forest", name: "Forest", symbol: "tree.fill", tint: .green,
                   scheme: "forest://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "gboard", name: "Gboard", symbol: "keyboard.fill", tint: .blue,
                   scheme: "gboard://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "overcast", name: "Overcast", symbol: "antenna.radiowaves.left.and.right", tint: .orange,
                   scheme: "overcast://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "castro", name: "Castro", symbol: "mic.circle.fill", tint: .orange,
                   scheme: "castro2://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "vlc", name: "VLC", symbol: "play.rectangle.fill", tint: .orange,
                   scheme: "vlc://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "vsco", name: "VSCO", symbol: "camera.filters", tint: .black,
                   scheme: "vsco://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "flickr", name: "Flickr", symbol: "photo.stack.fill", tint: .pink,
                   scheme: "flickr://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "bloomberg", name: "Bloomberg", symbol: "chart.line.uptrend.xyaxis", tint: .black,
                   scheme: "bloomberg://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "goodreads", name: "Goodreads", symbol: "books.vertical.fill", tint: .brown,
                   scheme: "goodreads://", webFallback: nil,
                   category: .social),
        CatalogApp(id: "firefoxfocus", name: "Firefox Focus", symbol: "flame.fill", tint: .purple,
                   scheme: "firefox-focus://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "halide", name: "Halide", symbol: "camera.aperture", tint: .black,
                   scheme: "halide://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "facetune", name: "Facetune", symbol: "wand.and.stars", tint: .pink,
                   scheme: "facetune://", webFallback: nil,
                   category: .media),
        CatalogApp(id: "sketchbook", name: "Sketchbook", symbol: "pencil.and.outline", tint: .blue,
                   scheme: "sketchbook://", webFallback: nil,
                   category: .productivity),
        CatalogApp(id: "tesla", name: "Tesla", symbol: "bolt.car.fill", tint: .red,
                   scheme: "tesla://", webFallback: nil,
                   category: .travel),
        CatalogApp(id: "rivian", name: "Rivian", symbol: "car.fill", tint: .green,
                   scheme: "rivian://", webFallback: nil,
                   category: .travel),
        CatalogApp(id: "fandango", name: "Fandango", symbol: "ticket.fill", tint: .orange,
                   scheme: "fandango://", webFallback: nil,
                   category: .travel),
        CatalogApp(id: "amc", name: "AMC Theatres", symbol: "popcorn.fill", tint: .red,
                   scheme: "amc://", webFallback: nil,
                   category: .travel),
        CatalogApp(id: "genshin", name: "Genshin Impact", symbol: "gamecontroller.fill", tint: .blue,
                   scheme: "yuanshengame://", webFallback: nil,
                   category: .games),
        CatalogApp(id: "discogs", name: "Discogs", symbol: "opticaldisc.fill", tint: .black,
                   scheme: "discogs://", webFallback: nil,
                   category: .media),
    ]
